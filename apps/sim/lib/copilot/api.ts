...
export interface SendMessageRequest {
  message: string
  userMessageId?: string // ID from frontend for user message
  chatId?: string
  workflowId?: string
  mode?: 'ask' | 'agent' | 'plan'
  model?: string // Allow any model name for custom providers
  provider?: string // Provider override from UI (e.g., 'mistral', 'openai-compatible', etc.)
  prefetch?: boolean
...
/**
 * Send a streaming message to copilot chat API
 * This is main API endpoint that handles all chat operations
 */
